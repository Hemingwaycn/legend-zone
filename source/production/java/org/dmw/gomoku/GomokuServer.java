...
class GomokuAI{
    ...
    public int aiscore(GomokuGame state3, int row, int col){
        int rvalue = 0;
        int p1500 = 9999, p1400 = 499, p1401 = 15, p1410 = 499, p1411 = 15, p1300 = 20, p1301 = 0, p1310 = 20, p1311 = 0, p1200 = 4, p1201 = 0, p1210 = 4, p1211 = 0, p1100 = 1, p1101 = 0;
        int p0500 = 1999, p0400 = 99, p0401 = 15, p0410 = 99, p0411 = 15, p0300 = 10, p0301 = 0, p0310 = 10, p0311 = 0, p0200 = 3, p0201 = 0, p0210 = 3, p0211 = 0, p0100 = 0, p0101 = 0;
        ...
        for(int i=0; i<=3; i++){
            if(dir[i] + dir[i+4] > 5){
                ...
                while(_i <= 2){
                    _i++;
                    if(dir[_i] + dir[_i+4] > 4 && state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]) && state3.chessman[row+dx[_i]*dir[_i]][col+dy[_i]*dir[_i]] == 0 && ((state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4]) && state3.chessman[row+dx[_i+4]*dir[_i+4]][col+dy[_i+4]*dir[_i+4]] == 2) || (! state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4])))){
                        rvalue += 5*p0401;
                    }
                    else if(dir[_i] + dir[_i+4] > 4 && ((state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]) && state3.chessman[row+dx[_i]*dir[_i]][col+dy[_i]*dir[_i]] == 2) || (! state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]))) && state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4]) && state3.chessman[row+dx[_i+4]*dir[_i+4]][col+dy[_i+4]*dir[_i+4]] == 0){
                        rvalue += 5*p0401;
                    }
                    else if(dir[_i] + dir[_i+4] > 3 && state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]) && state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4]) && state3.chessman[row+dx[_i]*dir[_i]][col+dy[_i]*dir[_i]] == 0 && state3.chessman[row+dx[_i+4]*dir[_i+4]][col+dy[_i+4]*dir[_i+4]] == 0){
                        rvalue += 5*p0300;
                    }
                    else if(dir1b[_i] + dir1b[_i+4] > 3 && state3.isNotOutOfBound(row+dx[_i]*dir1b[_i], col+dy[_i]*dir1b[_i]) && state3.isNotOutOfBound(row+dx[_i+4]*dir1b[_i+4], col+dy[_i+4]*dir1b[_i+4]) && state3.chessman[row+dx[_i]*dir1b[_i]][col+dy[_i]*dir1b[_i]] == 0 && state3.chessman[row+dx[_i+4]*dir1b[_i+4]][col+dy[_i+4]*dir1b[_i+4]] == 0){
                        rvalue += 5*p0310;
                    }
                }
            }
            else if(dir[i] + dir[i+4] > 4 && ((state3.isNotOutOfBound(row+dx[i]*dir[i], col+dy[i]*dir[i]) && state3.chessman[row+dx[i]*dir[i]][col+dy[i]*dir[i]] == 2) || (! state3.isNotOutOfBound(row+dx[i]*dir[i], col+dy[i]*dir[i]))) && state3.isNotOutOfBound(row+dx[i+4]*dir[i+4], col+dy[i+4]*dir[i+4]) && state3.chessman[row+dx[i+4]*dir[i+4]][col+dy[i+4]*dir[i+4]] == 0){
                rvalue += p0401;
                int _i = i;
                while(_i <= 2){
                    _i++;
                ...
                while(_i <= 2){
                    _i++;
                    if(dir[_i] + dir[_i+4] > 3 && state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]) && state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4]) && state3.chessman[row+dx[_i]*dir[_i]][col+dy[_i]*dir[_i]] == 0 && state3.chessman[row+dx[_i+4]*dir[_i+4]][col+dy[_i+4]*dir[_i+4]] == 0){
                        rvalue += 5*p0300;
                    }
                    else if(dir1b[_i] + dir1b[_i+4] > 3 && state3.isNotOutOfBound(row+dx[_i]*dir1b[_i], col+dy[_i]*dir1b[_i]) && state3.isNotOutOfBound(row+dx[_i+4]*dir1b[_i+4], col+dy[_i+4]*dir1b[_i+4]) && state3.chessman[row+dx[_i]*dir1b[_i]][col+dy[_i]*dir1b[_i]] == 0 && state3.chessman[row+dx[_i+4]*dir1b[_i+4]][col+dy[_i+4]*dir1b[_i+4]] == 0){
                        rvalue += 5*p0310;
                ...
                while(_i <= 2){
                    _i++;
                    if(dir1b[_i] + dir1b[_i+4] > 3 && state3.isNotOutOfBound(row+dx[_i]*dir1b[_i], col+dy[_i]*dir1b[_i]) && state3.isNotOutOfBound(row+dx[_i+4]*dir1b[_i+4], col+dy[_i+4]*dir1b[_i+4]) && state3.chessman[row+dx[_i]*dir1b[_i]][col+dy[_i]*dir1b[_i]] == 0 && state3.chessman[row+dx[_i+4]*dir1b[_i+4]][col+dy[_i+4]*dir1b[_i+4]] == 0){
                        rvalue += 5*p0310;
                    }
                }
            }
        ...
        for(int i=0; i<=3; i++){
            if(dir[i] + dir[i+4] > 5){
                ...
                while(_i <= 2){
                    _i++;
                    if(dir[_i] + dir[_i+4] > 4 && state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]) && state3.chessman[row+dx[_i]*dir[_i]][col+dy[_i]*dir[_i]] == 0 && ((state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4]) && state3.chessman[row+dx[_i+4]*dir[_i+4]][col+dy[_i+4]*dir[_i+4]] == 1) || (! state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4])))){
                        rvalue += 5*p1401;
                    }
                    else if(dir[_i] + dir[_i+4] > 4 && ((state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]) && state3.chessman[row+dx[_i]*dir[_i]][col+dy[_i]*dir[_i]] == 1) || (! state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]))) && state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4]) && state3.chessman[row+dx[_i+4]*dir[_i+4]][col+dy[_i+4]*dir[_i+4]] == 0){
                        rvalue += 5*p1401;
                    }
                    else if(dir[_i] + dir[_i+4] > 3 && state3.isNotOutOfBound(row+dx[_i]*dir[_i], col+dy[_i]*dir[_i]) && state3.isNotOutOfBound(row+dx[_i+4]*dir[_i+4], col+dy[_i+4]*dir[_i+4]) && state3.chessman[row+dx[_i]*dir[_i]][col+dy[_i]*dir[_i]] == 0 && state3.chessman[row+dx[_i+4]*dir[_i+4]][col+dy[_i+4]*dir[_i+4]] == 0){
                        rvalue += 5*p1300;
            ...
            else if(dir[i] + dir[i+4] > 4 && ((state3.isNotOutOfBound(row+dx[i]*dir[i], col+dy[i]*dir[i]) && state3.chessman[row+dx[i]*dir[i]][col+dy[i]*dir[i]] == 1) || (! state3.isNotOutOfBound(row+dx[i]*dir[i], col+dy[i]*dir[i]))) && state3.isNotOutOfBound(row+dx[i+4]*dir[i+4], col+dy[i+4]*dir[i+4]) && state3.chessman[row+dx[i+4]*dir[i+4]][col+dy[i+4]*dir[i+4]] == 0){
                rvalue += p1401;
                int _i = i;
                while(_i <= 2){
                    _i++;
