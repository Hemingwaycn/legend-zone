...
public class GomokuServlet extends HttpServlet
{
    ...
    {
        request.setAttribute("pendingGames", GomokuGame.getPendingGames());
            ...
            throws ServletException, IOException
    {
        ...
        else if("start".equalsIgnoreCase(action))
        {
            ...
            else
            {
                ...
                request.setAttribute("username", username);
                request.setAttribute("gameId", GomokuGame.queueGame(username));
                this.view("game", request, response);
            }
    ...
    private void view(String view, HttpServletRequest request,
            ...
            throws ServletException, IOException
    {
        request.getRequestDispatcher("/WEB-INF/jsp/view/gomoku/"+view+".jsp")
