...
@WebServlet(
        name = "scriptsAndScribesServlet",
        urlPatterns = "/scriptsAndScribes"
)
public class ScriptsAndScribesServlet extends HttpServlet
{
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException
    {
        request.setAttribute("pendingGames", ScriptsAndScribesGame.getPendingGames());
            ...
            throws ServletException, IOException
    {
        ...
        else if("start".equalsIgnoreCase(action))
        {
            ...
            else
            {
                ...
                request.setAttribute("username", username);
                request.setAttribute("gameId", ScriptsAndScribesGame.queueGame(username));
                this.view("game", request, response);
            }
    ...
    private void view(String view, HttpServletRequest request,
            ...
            throws ServletException, IOException
    {
        request.getRequestDispatcher("/WEB-INF/jsp/view/scriptsAndScribes/"+view+".jsp")
            ...
            throws IOException
    {
        response.sendRedirect(response.encodeRedirectURL(
                request.getContextPath() + "/scriptsAndScribes"
        ));
    }
}
