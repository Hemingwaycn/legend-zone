...
<html>
    <head>
        ...
        <title>LegendZone :: Black And White</title>
    ...
    <%@ include file="/header.jsp"%>
        ...
        <span class="player-label">游戏规则:每人拥有9张牌,分别为数字1~9,黑牌为奇数牌,白牌为偶数牌.每回合双方先后出牌,后出牌方能知道先出牌方的颜色,本回合胜者下回合先出牌,若本回合打平交换出牌次序.9回合获胜次数多的一方胜.</span><br />
            ...
            $(document).ready(function() {
                ...
                try {
                    server = new WebSocket('ws://' + window.location.host +
                            '<c:url value="/blackAndWhite/${gameId}/${username}">
